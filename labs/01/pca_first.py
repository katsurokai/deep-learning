...
parser.add_argument("--examples", default=55000, type=int, help="MNIST examples to use.")
parser.add_argument("--iterations", default=1024, type=int, help="Iterations of the power algorithm.")
